...
namespace dromozoa {
  namespace {
    ...
    void impl_push_string(lua_State* L) {
      ...
      luaX_push(L, sb, static_cast<signed char*>(sb), static_cast<const signed char*>(sb));
      unsigned char ub[] = { 0x62, 0x61, 0x72, 0x00 };
      luaX_push(L, ub, static_cast<unsigned char*>(ub), static_cast<const unsigned char*>(ub));
    }
